...
import 'new_game_image_model.dart';
export 'new_game_image_model.dart';

class NewGameImageWidget extends StatefulWidget {
  const NewGameImageWidget({Key? key}) : super(key: key);

  @override
  _NewGameImageWidgetState createState() => _NewGameImageWidgetState();
}

class _NewGameImageWidgetState extends State<NewGameImageWidget>
    with TickerProviderStateMixin {
  late NewGameImageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewGameImageModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().update(() {
        FFAppState().currentFourItem = functions
            .namesGetFourItems(
                FFAppState().newGameAuthors.toList(),
